 ...
 *
 * @see adaptivetheme_preprocess_gs2_25_75()
...
<div class="at-panel panel-display gs2-25-75 clearfix" <?php if (!empty($css_id)): print "id=\"$css_id\""; endif; ?>>
  
  <?php if ($content['gs2_25_75_header']): ?>
  <div id="panel-feature">
    <div class="container clearfix">
      <div class="region region-gs2-25-75-header region-conditional-stack">
        <div class="region-inner clearfix">
          <?php print $content['gs2_25_75_header']; ?>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="panel-content">
    <div class="container clearfix">
      ...
      <div class="region region-gs2-25-75-sidebar">
        <div class="region-inner clearfix">
          <?php print $content['gs2_25_75_sidebar']; ?>
        </div>
      </div>

      <div class="inset-wrapper clearfix">    
        <div class="region region-gs2-25-75-inset">
          <div class="region-inner clearfix">
            <?php print $content['gs2_25_75_inset']; ?>
          </div>
        </div>        
      </div>
