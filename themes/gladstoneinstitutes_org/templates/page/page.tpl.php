 ...
 * - $is_panel: TRUE if the current page is under Panels control.
 *
 * Site identity:
      ...
      <div<?php print $branding_attributes; ?>>
        ...
        <?php elseif ($site_name || $site_slogan): ?>
          ...
          <hgroup<?php print $hgroup_attributes; ?>>
            ...
            <?php if ($site_slogan): ?>
              <h1 id="name-slogan-spacer">|</h1>
              <h1<?php print $site_slogan_attributes; ?>><?php print $site_slogan; ?></h2>
            <?php endif; ?>
      ...
      <div class="content-inner">
        ...
        <<?php print $tag; ?> id="main-content">
          ...
          <?php if ($content = render($page['content'])): ?>
            <div id="content" class="region <?php if(!$is_panel){ print "content-box"; } ?>">
              <?php print $content; ?>
            </div>
          <?php endif; ?>
